...
<div class="hidden-xs" id="topbar_menu">
   <ul class="nav navbar-nav navbar-right">
      <li><a class="tooltip-bottom" title="New Sale" data-toggle="tooltip" href="{{ route('sales.create') }}"><i class="fa fa-plus"></i> New Sale</a></li>
      <li><a class="tooltip-bottom" title="Cart" data-toggle="tooltip" href="{{ route('home') }}"><i class="fi-shopping-cart"></i></a></li>
      <li><a class="tooltip-bottom" title="Sales" data-toggle="tooltip" href="{{ route('sales.index') }}"><i class="fa fa-rupee"></i></a></li>
...
<div class="visible-xs col-xs-6 sidebar-offcanvas" id="sidebar">
   <div class="list-group">
      <a href="{{ route('sales.create') }}" class="list-group-item"><i class="fa fa-plus"></i> New Sale</a>
      <a href="{{ route('home') }}" class="list-group-item"><i class="fi-shopping-cart"></i> Cart</a>
      <a href="{{ route('sales.index') }}" class="list-group-item"><i class="fa fa-rupee"></i> Sales</a>
