      ...
      <div class="row">
         <div class="panel panel-default">
            ...
            <div class="panel-heading">
               ...
               <h3 class="panel-title"><i class="fi-page-edit"></i> Edit Customer</h3>
            </div>

            <div class="panel-body">
               {{ Form::open(['url' => route('customers.update', $customer->id), 'method' => 'put', 'class' => 'form-vertical', 'autocomplete' => 'off']) }}
